<template>
  ...
  >
    <div class="relative flex-auto p-6">
      <p
        class="my-4 text-lg leading-relaxed text-gray-500"
        v-text="message"
      ></p>
      <p
        class="w-2/3 overflow-hidden text-xs text-gray-500 whitespace-nowrap overflow-ellipsis"
        title="link"
        v-show="link"
        v-text="link"
      ></p>
...
export default {
  ...
  mounted() {
    ...
    document.addEventListener("confirm", (e) => {
      ...
      this.confirmText = e.detail.confirmText
