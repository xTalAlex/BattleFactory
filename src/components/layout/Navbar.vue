<template>
  <div>
    <Backdrop classes="lg:hidden" v-show="visible" @clickedOutside="hide()" />

    <nav
      class="fixed top-0 z-40 flex flex-wrap items-center justify-between w-full px-2 py-3 bg-black/40 backdrop-blur-lg md:backdrop-blur-sm"
    >
      <div
      ...
      >
        ...
        >
          <a
            class="inline-block py-2 mr-4 text-sm font-bold leading-relaxed uppercase outline-none focus:outline-none whitespace-nowrap text-secondary-200"
            :href="homeUrl"
            >Unite Agency</a
          >
        ...
        <div
          class="relative items-center flex-grow bg-transparent lg:visible lg:flex shadow-b-md"
          :class="{
            hidden: !visible,
            block: visible,
          }"
        >
          <ul class="flex flex-col mr-auto list-none lg:flex-row">
            <li class="flex items-center">
              ...
              >
                <i
                  class="mr-1 fa fa-arrow-alt-circle-up text-secondary-100"
                ></i>
                {{ submitButton }}
              </a>
            </li>
          ...
          <ul class="flex flex-col list-none lg:flex-row lg:ml-auto">
            ...
            <li class="flex items-center mt-4 lg:mt-0">
              <form method="GET" :action="indexUrl">
                ...
                >
                  <Database
                    class="-mt-1 text-secondary-500 inline-block w-4 h-4"
                  />
                  {{ indexButton }}
                </button>
              </form>
