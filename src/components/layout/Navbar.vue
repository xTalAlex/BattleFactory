<template>
    ...
    <nav class="fixed top-0 z-40 flex flex-wrap items-center justify-between w-full px-2 py-3 bg-black/40 backdrop-blur-lg md:backdrop-blur-sm">
        <div class="container flex flex-wrap items-center justify-between px-4 mx-auto" >
            ...
            <div class="relative items-center flex-grow bg-transparent hidden lg:flex shadow-b-md"
                ref="menu"
            >
                ...
                <ul class="flex flex-col mr-auto list-none lg:flex-row">
                    ...
                    <a
                        ...
                        href="#"
                        ><i
                        class="mr-2 text-lg text-secondary-100 far fa-file-alt leading-lg"
                        ></i>
                        Docs</a
                    >
                    </li>
    ...
    export default {
        ...
        methods : {
            toggle(){
                ...
                this.$refs.menu.classList.toggle('block'); 
            },

            hide(){
                this.visible = false;
                this.$refs.menu.classList.remove('block');
